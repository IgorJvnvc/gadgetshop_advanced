...
function exportWord(){
    ...
    $word->Documents->Open("http://localhost/pphp sajt/data/export/aboutMe.doc");

    $word->Selection->TypeText(`
        Full Name:Igor jovanovic
        Index Number:127/18
        I was born in Belgrade on the 29th of October 1998. I graduated electro-technical high school "Nikola Tesla" profile: "Electro-Technician of Telecommunications".
    ...
    $word->Documents[1]->SaveAs("http://localhost/pphp sajt/data/export/aboutMe.doc");
