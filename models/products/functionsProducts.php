...
function exportExcel(){
    ...
    $workbook = $excel->Workbooks->Open("http://localhost/pphp sajt/data/export/products.xls") or die("did not open");
    ...
    $workbook->_SaveAs("http://localhost/pphp sajt/data/export/products.xls",-4143);
    $workbook->Save();
